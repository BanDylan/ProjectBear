...
using Administration = ProjectBear.CMS.Web.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "icon-screen-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: ProjectBear.CMS.Web.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
