...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Content
        {
            ...
            {
                public const string RosterManagementForm = "~/Modules/Content/RosterManagement/RosterManagementForm.cshtml";
                public const string RosterManagementIndex = "~/Modules/Content/RosterManagement/RosterManagementIndex.cshtml";
            }
        }
