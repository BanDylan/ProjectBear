...
namespace ProjectBear.CMS.ViewModels
{
    public class PlayerViewModel
    {
        ...
        public PlayerViewModel(Guid profileId, string matchingPlayerName, bool showCurrentSteamName)
        {
            ...
            var bookings = db.PlayersInTimeSlot.Where(x => x.ProfileId == profileId).ToList();
