namespace ProjectBear.Data.Migrations
{
    ...
    public partial class Setup : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.TimeSlotTemplates",
                c => new
                    {
                        TimeSlotTemplateId = c.Guid(nullable: false, identity: true),
                        RosterTemplateId = c.Guid(nullable: false),
                        Length = c.Int(nullable: false),
                        Offset = c.Int(nullable: false),
                        GameName = c.String(nullable: false),
                        NumberOfPlayers = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.TimeSlotTemplateId)
                .ForeignKey("dbo.RosterTemplates", t => t.RosterTemplateId, cascadeDelete: true)
                .Index(t => t.RosterTemplateId);
            
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.TimeSlotTemplates", "RosterTemplateId", "dbo.RosterTemplates");
            ...
            DropIndex("dbo.TimeSlotTemplates", new[] { "RosterTemplateId" });
            ...
            DropTable("dbo.TimeSlotTemplates");
